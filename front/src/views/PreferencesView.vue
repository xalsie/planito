<template>
  <div class="container mx-auto px-6 py-8">
    <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
      <h2 class="text-2xl font-semibold text-gray-800 mb-6 font-poppins">Préférences des intervenants</h2>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      <h2 class="text-2xl font-semibold text-gray-800 mb-6 font-poppins">Liste des préférences</h2>
      
      <div class="overflow-x-auto">
        <table class="w-full">
          <thead class="bg-gray-50 border-b">
            <tr>
              <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 font-poppins">Intervenant</th>
              <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 font-poppins">Modules</th>
              <th class="px-6 py-3 text-left text-sm font-medium text-gray-700 font-poppins">Préférences</th>
              ...
              <td class="px-6 py-4 text-sm text-gray-700">
                <div v-for="module in intervenant.modules" :key="module.id">
                  <span v-for="(preference, index) in module.preferences" :key="index" class="font-poppins">
                    {{ preference }}{{ index < module.preferences.length - 1 ? ', ' : '' }}
                  </span>
                </div>
              </td>
              <td class="px-6 py-4 text-right">
                <button 
                  @click="deletePref(module.id)"
